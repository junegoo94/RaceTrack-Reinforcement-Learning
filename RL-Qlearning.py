...
def qlearning(num_of_episodes, num_agents):
    ...
    for episode in range(num_of_episodes):
        ...
        updated_avg = get_average(q_table, num_agents)
        avg_lst.append(updated_avg)
...
num_of_episodes = 150
num_agents = 30
q_mean_return = qlearning(num_of_episodes, num_agents)

x_episode = np.linspace(1, num_of_episodes + 1, num_of_episodes)
plt.figure()
plt.plot(x_episode, q_mean_return)
plt.xlabel('Episode')
